...
plot_autid <-  ggplot(expanded, 
  ...
  geom_label(data = uy_media,
             aes(label = sd , x= 13.5), fill = "white",
             fontface="bold", size=4, show.legend = FALSE, vjust=-.25) +
  annotate("text",
           label = "Media",
           x = 12, 
...
plot_autid <-  ggplot(expanded, 
  ...
  scale_x_continuous(breaks = seq(0, 10, by = 2)) +
  geom_label(data = uy_media,
             aes(label = Media , x= 13.5), fill = "white",
             fontface="bold", size=4, show.legend = FALSE, vjust=-.25) +
  geom_label(data = uy_media,
             aes(label = sd , x= 14.5), fill = "white",
             fontface="bold", size=4, show.legend = FALSE, vjust=-.25) +
  annotate("text",
           label = "Media",
           x = 13.5, 
