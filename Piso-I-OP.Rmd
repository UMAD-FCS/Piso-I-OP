...
En los últimos años se ha hablado mucho sobre el error de las encuestas de opinión pública -particularmente sobre indicadores de intención de voto-, sus métodos y validez como instrumento.  La elección de Donald Trump como presidente de Estados Unidos en 2016, el Brexit o la primera vuelta de las elecciones de 2014 en Uruguay suelen son algunos de los ejemplos que suelen ser citados por los críticos de los sondeos de opinión pública. Sin embargo, un metaanálisis reciente que incluyó 30000 encuestas en 45 países entre 1942 y 2017 no encontró evidencia de un aumento en el error de las encuestas de intención de voto (Jennings y Wlezien, 2018). Más allá de que la tendencia global no sea hacia el aumento del error en las encuestas de opinión pública, ejemplos como los citados anteriormente y otros sugieren que estas pueden alejarse de los parámetros poblacionales y por ende al analizar los resultados de una encuesta de opinión pública se deben analizar su metodología y tener en cuenta las posibles fuentes de error.
