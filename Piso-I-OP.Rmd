...
La teoría del error total de encuesta es un marco conceptual que intenta describir los errores estadísticos de una encuesta incorporando distintos tipos de encuestas ([Grover y Lyberg, 2010](https://academic.oup.com/poq/article-abstract/74/5/849/1817502)). A diferencia del error muestral en muestras probabilísticas muchos de las otras fuentes de error de una encuesta no pueden ser estimados matemáticamente, aunque si existe mucha literatura sobre como reducirlos. 

Algunos de los errores no muestrales a tener en cuenta son:

<ol>
  <br />
  <li>**Sesgo de no respuesta:** este tipo de error puede ocurrir cuando los encuestados seleccionados en la muestra no pueden o se niegan a ser contactados. Este es uno de los problemas más frecuentes y relevantes de la investigación en opinión pública, con una tendencia al aumento de la tasa de no respuesta. Este error puede sesgar la muestra si las personas que se niegan o no pueden participar difieren sistemáticamente de las que si participan. </li>
  <br />
  <li> **Error de cobertura:** ocurre cuando hay un desfasaje entre la población objetivo y la población del marco muestral. Ejemplo: cuando se utilizan encuestas telefónicas y las personas que no tienen teléfono son de interés para la investigación (nunca van a poder ser incluidas en la encuesta) </li>
  <br />
  <li>**Errores en las respuestas:** los encuestados pueden no responder de forma sincera si no están lo suficientemente motivados como para hacerlo, o las preguntas no son lo suficientemente claras. A su vez, los encuestadores pueden cometer inducir error sistemático al encuestar ([Weisberg, 2018](https://www.degruyter.com/document/doi/10.7208/9780226891293/html)). </li>
</ol>

### **Metodología de encuestas utilizadas**
...
Otro indicador frequente en encuestas de opinión pública es la percepción sobre el principal problema del país. La percepción sobre el principal problema del país es un indicador para la prominencia o relvancia de cada tema -*issue salience*-. Cuando un tema es importante para el público los candidatos y partidos suelen tomar posición al respecto ([Wlezien y Soroka, 2007](https://scholar.google.es/scholar?hl=es&as_sdt=0%2C5&q=The+Relationship+between+Public+Opinion+and+Policy+oxford+handbook&btnG=)). A su vez, los ciudanos suelen preocuparse y tener opiniones formadas respecto a estos temas. Aunque es importante destacar que la pregunta sobre el principal problema del país no siempre es el mejor indicador para obtener la saliencia de todos los temas debido a que al preguntar por problemas no surgen temas donde el gobierno haya actuado bien ([Wlezien, 2005](https://www.sciencedirect.com/science/article/pii/S026137940500020X?casa_token=Al5HAqI4XjQAAAAA:_dsDUL4RfBGvSSD1ldWERlHitCqIpiQsy0QQmI5SQq0XKHu77_eI6YkfAFy2ExOJGnn8TNRpKQM)). 
